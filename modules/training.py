...
class Module(threading.Thread):
    ...
    def run(self):
        log.info("[TrainingAgent] Thread has started. Waiting for initial data population...")
        ...
        while not self.stop_event.is_set():
            try:
                ...
                account = accounts[0] # Operates on the first account
            ...
            self.stop_event.wait(60) # Wait before starting the next village cycle